 ...
 */
public class FacebukFullTester {
	...
	public void testFindBestMoment () {
		...
		System.out.println("CS2103GRDR +1 (R2 getOverallHappiestMoment A)");
	}

	@Test
	public void testGetFriendWithWhomIAmHappiest () {
		assertEquals(_michelle.getFriendWithWhomIAmHappiest(), _barack);
		System.out.println("CS2103GRDR +2 (R2 getFriendWithWhomIAmHappiest A)");
	}
	...
	public void testFacebukFromProjectDescription () {
		...
		System.out.println("CS2103GRDR +8 (R1 basic functionality)");
	}
	...
	public void testGetOverallHappiestMomentEmpty () {
		...
		System.out.println("CS2103GRDR +1 (R2 getOverallHappiestMoment B)");
	}
	...
	public void testGetOverallHappiestMomentSingleParticipant () {
		...
		System.out.println("CS2103GRDR +1 (R2 getOverallHappiestMoment C)");
	}
	...
	public void testGetOverallHappiestMomentPerson () {
		...
		System.out.println("CS2103GRDR +1 (R2 getOverallHappiestMoment D)");
	}
	...
	public void testGetOverallHappiestMomentPet () {
		...
		Moment happiestMoment = (Moment) person1.getOverallHappiestMoment();
		assertEquals(moment3, happiestMoment);
		System.out.println("CS2103GRDR +1 (R2 getOverallHappiestMoment E)");
	}
	...
	public void testGetFriendWithWhomIAmHappiestEmpty2 () {
		...
		Object bestFriend = person1.getFriendWithWhomIAmHappiest();
		assertNull(bestFriend);
		System.out.println("CS2103GRDR +1 (R2 getFriendWithWhomIAmHappiest B)");
	}
	...
	public void testGetFriendWithWhomIAmHappiestPerson () {
		...
		System.out.println("CS2103GRDR +1 (R2 getFriendWithWhomIAmHappiest C)");
	}
	...
	public void testGetFriendWithWhomIAmHappiestPet () {
		...
		System.out.println("CS2103GRDR +1 (R2 getFriendWithWhomIAmHappiest D)");
	}
	...
	public void testFriendRequest1 () {
		...
		// Make sure the code compiles for making friend requests for people and pets
		FriendRequest friendRequest1 = new FriendRequest(person1, pet1);
		FriendRequest friendRequest2 = new FriendRequest(person1, person2);
		System.out.println("CS2103GRDR +1 (R1 testFriendRequest1)");
	}
	...
	public void testFriendRequest2 () {
		...
		System.out.println("CS2103GRDR +1 (R1 testFriendRequest2)");
	...
	public void testFriendRequest3 () {
		...
		Person person2 = new Person("person2", new Image("person2.png"));
		Person person3 = new Person("person3", new Image("person3.png"));
		ArrayList person3List = new ArrayList();
		person3List.add(person3);
		person1.setFriends(person3List);
		person2.setFriends(person3List);

		FriendRequest friendRequest = new FriendRequest(person1, person2);

		// Friends not added until both entities approve it
		...
		friendRequest.approve(person1);  // person1 approved it 2x
		assertFalse(person1.getFriends().contains(person2));
		assertFalse(person2.getFriends().contains(person1));
		System.out.println("CS2103GRDR +1 (R1 testFriendRequest3 A)");
		...
		System.out.println("CS2103GRDR +1 (R1 testFriendRequest3 B)");
	}
	...
	public void testFindMaximumClique2 () {
		...
		testFindMaximumClique(isFriends, new String[] { "2", "3", "4" }, new String[] { "1" }, 2, "FindMaximumCliqueTest2");
	}
	...
	private void testMaximumCliqueSize (boolean[][] isFriends, int desiredMaxCliqueSize, int numPoints, String testName) {
		...
		System.out.println("CS2103GRDR +" + numPoints + " (R3" + testName + ")");
	}
	...
	private void testFindMaximumClique (boolean[][] isFriends, String[] namesInSolution, String[] namesNotInSolution, int numPoints, String testName) {
		...
		System.out.println("CS2103GRDR +" + numPoints + " " + testName);
	}
}